...
idade = ano_atual - ano
print('\033[1mDigite uma senha forte, ela deve conter no minimo uma letra maiuscula e 8 números, e não pode conter seu nome nela. \033[1;31mNão adicione caracteres especiais.\033[0m')
