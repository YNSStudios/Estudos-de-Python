...
print('\033[1mDigite uma senha forte (mínimo 8 caracteres, sem seu nome e apenas letras/números).\033[0m')
...
''')
    ...
    print('\033[31mSenha Fraca ou Inválida! Não atende aos requisitos de segurança.\033[0m')